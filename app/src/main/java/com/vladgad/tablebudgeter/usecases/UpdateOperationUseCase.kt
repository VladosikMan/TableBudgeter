...
class UpdateOperationUseCase(private val repository: Repository) {
    suspend operator fun invoke(id: Long, operation: Operation): OperationStatus {
        // 1. Бизнес‑валидация
        ...
        return repository.updateOperation(id, operation)
    }
}
